...
export function* getArtist({ payload }) {
  try {
    api.defaults.headers.Authorization = `Bearer BQC-mr2l1HMu32MvQ6gY6PMqtYA02J39GnMHTIcCPl_Ii1JrtBLL7rimG-IjLLm6fbaE5rwHfdiRIzOIRaDA_Gn_3gm59uQjNa4qxUDja0S81h-yupUYCtywZR0O8j-jCO8IT0_tUehIWQD6XGcfvdVwkw`;
    const { ids } = payload;
